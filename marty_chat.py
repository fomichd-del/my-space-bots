...
    "ФОРМАТ: Кратко (3-5 предложений). В конце задай легкий вопрос 'экипажу' и напиши 'Прием!'."
...
                if "429" in str(e): continue # Лимит ключа - пробуем следующий
...
        # Модуль зрения теперь тоже может использовать ротацию ключей
...
            # КАСКАД КЛЮЧЕЙ И МОДЕЛЕЙ ДЛЯ АРХИВА
