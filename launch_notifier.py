...
# Секреты (токен и имя канала) — они подгружаются из настроек GitHub
TELEGRAM_TOKEN = os.getenv('TELEGRAM_TOKEN')
CHANNEL_NAME = '@vladislav_space'

def check_launches():
    # 1. Получаем данные о запуске
    ...
    # 2. ОГРОМНЫЙ СПИСОК СЕКРЕТОВ (50 штук!) 📚
    secrets_list = [
        ...
        "🧊 <b>КОМЕТЫ:</b> Кометы — это «грязные снежки» из изо льда и пыли! ☄️",
    ...
    # 3. Марти выбирает один случайный секрет 🎲
    ...
    report += "--------------------------\n"
    report += f"🎒 <b>ШКОЛА ЮНОГО ИНЖЕНЕРА</b>\n{chosen_secret}\n"
    report += "--------------------------\n\n"
    
    report += "🌌 Канал: <a href='https://t.me/vladislav_space'>Дневник юного космонавта</a>"
