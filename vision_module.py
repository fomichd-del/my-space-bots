...
def analyze_image(image_data, user_context=""):
    ...
    prompt = (
        ...
        "2. ШКОЛА: Если это просто задача — помоги найти решение или подбодри. "
        "3. КОСМОС: Если это небо или звезды — расскажи научный факт. "
        "4. ЦЕНЗУРА (СТРОГО): Запрещено обсуждать секс, смерть, насилие, политику. Если на фото что-то неподобающее, ответь: 'Пилот, эти визуальные частоты заблокированы Академией!'. "
