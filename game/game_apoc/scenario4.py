...
def run_scenario(bot, call):
    ...
    # --- [ ЭТАП 3: ШИФР ЗУБНОЙ ФОРМУЛЫ ] ---
        ...
        text = (f"📂 **ЭТАП 3: ПЕРФОКАРТА СУДЬБЫ**\n\n"
  ...
  # --- [ ЭТАП 6: ВИДЕО ИЗ БЕЗДНЫ ] ---
    ...
    # --- [ ЭТАП 8: ШИФР «ЧЕТВЕРТОГО ПОКОЛЕНИЯ» ] ---
        ...
        text = (f"🦷 **ЭТАП 8: НАСЛЕДСТВЕННЫЙ ЗАМОК**\n\n"
  ...
  # --- [ ЭТАП 11: ДИАЛОГ С ОТРАЖЕНИЕМ ] ---
        ...
        text = (f"🪞 **ЭТАП 11: ЛИЦО ПОД МАСКОЙ**\n"
                f"──────────────────────────\n"
    ...
    # --- [ ЭТАП 14: ПРИЗНАНИЕ ФАНТОМА ] ---
        ...
        text = (f"🎙 **ЭТАП 14: ГОЛОС ПРЕДАТЕЛЯ**\n\n"
    ...
    # --- [ ЭТАП 15: ПЕРВЫЙ СЕАНС ] ---
        ...
        text = (f"⚡️ **ЭТАП 15: ГЛОБАЛЬНЫЙ РЕЗОНАНС**\n\n"
  ...
  # --- [ ЭТАП 16: СПУСК К ТОЧКЕ НОЛЬ ] ---
        ...
        text = (f"📉 **ЭТАП 16: ВНИЗ ПО ВЕНАМ ГОРОДА**\n"
                f"──────────────────────────\n"
    ...
    # --- [ ЭТАП 17: ПОРОГ «ДВЕРИ НОЛЬ» ] ---
        ...
        text = (f"🦷 **ЭТАП 17: БИОЛОГИЧЕСКИЙ БАРЬЕР**\n\n"
    ...
    # --- [ ЭТАП 18: ЛИЦО БЕЗ МАСКИ ] ---
        ...
        text = (f"🌑 **ЭТАП 18: ЗЕРКАЛО ТРЕСНУЛО**\n\n"
    ...
    # --- [ ЭТАП 19: ОБЪЕКТ «ВЛАД» ] ---
        ...
        text = (f"⚰️ **ЭТАП 19: КОЛЫБЕЛЬ ИЗ ТИТАНА**\n\n"
    ...
    # --- [ ЭТАП 20: ПЕРВЫЙ ВЗДОХ ] ---
        ...
        text = (f"👁 **ЭТАП 20: ПРОБУЖДЕНИЕ НАСЛЕДНИКА**\n\n"
  ...
  # --- [ ЭТАП 21: ТЕПЛО ЖИЗНИ ] ---
        ...
        text = (f"🧬 **ЭТАП 21: ВЫХОД ИЗ СТАЗИСА**\n"
                f"──────────────────────────\n"
    ...
    # --- [ ЭТАП 22: КОД СОВЕРШЕННОЛЕТИЯ ] ---
        ...
        text = (f"🦷 **ЭТАП 22: ЗАМОК ПОСТОЯНСТВА**\n\n"
    ...
    # --- [ ЭТАП 23: ОТРЯД СМЕРТИ ] ---
        ...
        text = (f"🛡 **ЭТАП 23: ЗАСАДА В КОРИДОРЕ**\n\n"
    ...
    # --- [ ЭТАП 25: ПУТЬ К НЕБОСКРЕБАМ ] ---
        ...
        text = (f"🚇 **ЭТАП 25: ПОЕЗД ПРИЗРАКОВ**\n\n"
  ...
  # --- [ ЭТАП 26: ВОКЗАЛ «ЗЕНИТ» ] ---
    ...
    # --- [ ЭТАП 27: ШИФР ПОСЛЕДНЕЙ СМЕНЫ ] ---
        ...
        text = (f"🦷 **ЭТАП 27: ПРОЩАНИЕ С ПРОШЛЫМ**\n\n"
    ...
    # --- [ ЭТАП 28: ВЕРШИНА МИРА ] ---
        ...
        text = (f"🏙 **ЭТАП 28: ПАНОРАМА КАТАСТРОФЫ**\n\n"
