...
DOG_SHOP = {
    ...
    "dragon_wings": {"name": "Крылья Дракона", "prompt": "wearing a heavy dark leather chest harness that has two massive, wide-open black dragon wings firmly attached to the back, highly detailed leathery texture spreading across the frame, dominating the silhouette", "price": 75},
    ...
    "holographic_wings": {"name": "Крылья Ангела", "prompt": "wearing a high-tech metallic backpack module that projects two massive, wide-open glowing white holographic angel wings made of pure bright light, casting strong rays onto the cabin walls", "price": 85},
    ...
    "plasma_ball": {"name": "Плазменный мяч", "prompt": "physically resting a glowing glass plasma ball toy between its front paws, realistic static electricity making the fur stand up slightly", "price": 0},
    ...
    "energy_shield_orb": {"name": "Сфера-щит", "prompt": "a physical metallic module on the dog's harness is projecting a visible semi-transparent blue energy shield bubble completely enclosing the dog", "price": 0},
    "quantum_leash": {"name": "Квантовый поводок", "prompt": "a glowing purple energy leash is physically clipped to the dog's collar metal ring, trailing off into the background, realistic bright reflections on the fur", "price": 0},
    ...
    "cyberspace_aura": {"name": "Аура Матрицы", "prompt": "wearing a high-tech collar projector casting a dense realistic hologram of falling green digital matrix code directly onto the dog's fur and surrounding floor", "price": 0},
    ...
    "symbiote_friend": {"name": "Симбиот-Компаньон", "prompt": "a tiny, hyper-realistic cute alien creature with glowing blue eyes is physically sitting securely on top of the dog's head, holding onto the fur", "price": 1},
    "mecha_tail": {"name": "Кибер-хвост", "prompt": "the dog's tail is completely replaced by a highly detailed, articulated chrome cybernetic tail with glowing neon blue joints and wiring", "price": 3},
    "cryo_gear": {"name": "Крио-генератор", "prompt": "wearing a heavy futuristic backpack pumping out dense, realistic freezing white fog that spills over the dog's paws and covers the floor", "price": 7},
    "hover_board": {"name": "Антиграв-доска", "prompt": "all four paws are planted firmly on a glowing, metallic sci-fi hoverboard that is floating a few inches above the floor, blue thruster light reflecting below", "price": 5},
    "holographic_butterfly": {"name": "Голо-бабочка", "prompt": "a glowing, semi-transparent neon blue holographic butterfly is physically resting gently on the dog's wet nose, illuminating the face", "price": 5},
